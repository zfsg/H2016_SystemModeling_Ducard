...
Only dependent on the body's coordinates, not on its velocity oder acceleration.
...
\mportant{$\ddt [C](t) = \frac{\overset{\ast}{m}_C}{M_C \cdot V_C}$}
...
Where $\bar{x}(t)\in\mathbb{R}^n,\ \bar{u}(t)\in\mathbb{m},\ \bar{y}(t)\in\mathbb{R}^p$.
...
Lyapunov theorems provide sufficient but not necessary conditions. Many extensions proposed (LaSalle, Hahn, ect.).
